    ...
    <div class="report-header">
      <div class="clearFix" style="height: 60px;">
        <div class="report-date">
          ...
          <el-select v-model="reportNum" style="width:200px;" disabled>
            <el-option :value="options1"></el-option>
          </el-select>
        </div>
...
<script>
  import {getReportById, reportUpdate, exportReport, getAuditor} from 'api/supervision/index'
  ...
  export default {
    ...
    created(){
        ...
        getReportById(data).then(response => {
          ...
          this.options1 = response.data.reportNumber
          this.notes = response.data.notes
          this.year = this.options1.substr(0,5)
          this.month = this.options1.substr(6,1)
        });
      ...
      infoSave(){
        ...
        reportUpdate(data).then(response => {
          if(response.code !== -1){
            ...
            this.$router.push({name:'overseeReport'})
          }else{
