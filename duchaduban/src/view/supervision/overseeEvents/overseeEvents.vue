<template>
  <div class="content-wrapper">
    ...
    <div class="tab-toolbar">
      ...
      <div class="cbs-select">
        ...
        <el-input v-model="input1" placeholder="请输入内容" style="width:250px;"></el-input>
            ...
            <div class="cbs-select">
         <span class="mar-l-40" style="margin-left:76px">办理状态</span>
      ...
      <el-row>
       ...
       <div class="active-time">
        <span style="margin-left:-6px">上报日期</span>
    ...
    <div class="list">
      <el-table :data="tableData" class="table1" style="width: 100%" :row-class-name="tableRowClassName">
         ...
         <el-table-column label="操作" width="260">
            <template slot-scope="scope">
              ...
              <el-button type="text"  size="small" @click="progress(scope.row.wsId)" v-show="scope.row.superviseReport">
                <i class="icon iconfont icon-tianjiashangbao"></i>进展报送
              </el-button>
              <el-button type="text"  size="small" @click="updata(scope.row.wsId)" v-show="scope.row.superviseUpdatePower">
  ...
  export default {
    ...
    methods:{
      ...
      handleCurrentChange(val) {
       ...
       updata(id){
        this.$router.push({name:'overseeEventsUpdata',params:{wsId:id}});
      },
      progress(id){
        this.$router.push({name:'overseeEventsProgress',params:{wsId:id}});
      },
      detail(id){
        this.$router.push({name:'overseeEventsDetail',params:{wsId:id}});
      },
      typeIndex(index) {
