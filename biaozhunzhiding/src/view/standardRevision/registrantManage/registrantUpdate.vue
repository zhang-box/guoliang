<template>
  <div class="content-wrapper">
    <div class="content-title">
      ...
      <span class="title-info">人员修改</span>
      <span class="required-msg">带<em>*</em>部分必须填写</span>
    </div>
    <div class="content-main registrantForm" style="height: 700px;">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="用户名：" label-width="145px" prop="userName">
              <el-input v-if="!showType" v-model="ruleForm.userName" style="width:400px;" disabled></el-input>
